      ...
      <header className="bg-[#ff5200] font-serif">
        <div className="flex justify-around container mx-auto py-8">
          ...
          <div className="font-serif text-white text-base font-bold flex gap-15 items-center">
            ...
            <a
              className="border border-black py-3 px-4 bg-black rounded-2xl"
              target="_blank"
              href="https://www.swiggy.com/corporate/"
            >
              Sign in
        ...
        <div className=" pt-16 pb-8 relative">
          ...
          <div className="max-w-[70%] container mx-auto flex  justify-center gap-15 mt-5">
            <input
              className="bg-white w-[30%] text-base px-6 py-4 rounded-2xl"
              placeholder="Delhi, India"
            ></input>
            <input
              className="bg-white w-[50%] text-base px-6 py-4 rounded-2xl"
              placeholder="Search for restaurant and item for more"
            ></input>
          </div>
        </div>
